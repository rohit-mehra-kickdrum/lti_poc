...
class LTIPlatform(object):
    ...
    def __init__(self, url):
        self.name = 'LTI Poc Platform'
        self.description = 'LTI Poc Test Platform'
        self.guid = 'ltipoc_at_' + str(int(time()))
        self.contact_email = 'john.doe@gmail.com'
        self.version = '2025JAN01'
        self.url = url
        self.courses = {}
        self.tools = []
